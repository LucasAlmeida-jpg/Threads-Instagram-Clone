<template>
    <div id="MainLayout" class="h-screen">
        <div class="w-full max-w-500 mx-auto">
        ...
        <div id="BottomNav" class="fixed z-50 bottom-0 flex w-full h-[70px] border-t border-t-gray-700 bg-black">
            <div class="flex w-full max-w-[500px] mx-auto flex items-center justify-around">
                ...
                <Icon name="material-symbols:home-outline" size="32" color="#ffffff" />
                </button>
                <button @click="userStore.isMenuOverlay = tryUseNuxt" class="w-full h-full">
                <Icon name="material-symbols:edit-square-outline-rounded" size="32" color="#ffffff" />
                </button>
                <button @click="userStore.isLogoutOverlay = tryUseNuxt" class="w-full h-full">
